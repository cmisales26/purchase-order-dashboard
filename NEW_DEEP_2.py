...
def create_invoice_pdf(invoice_data, logo_file="logo_final.jpg", stamp_file="stamp.jpg"):
    ...
    for i, (label, value) in enumerate(vendor_lines):
        ...
        pdf.set_font(pdf.default_font, "B", 12)
        label_width = pdf.get_string_width(label) 
        pdf.cell(label_width, 6.5, label, border="L", ln=0)
        pdf.set_font(pdf.default_font, "", 12)
        border = "R" if i < len(vendor_lines) - 1 else "R"
        pdf.cell(97 - label_width, 6.5, value, border=border, ln=1)
    ...
    pdf.cell(60, 6, "State Tax", border=1, ln=True, align="C")
    ...
    # pdf.ln(2)
    pdf.set_font(pdf.default_font, "B", 10)
    pdf.cell(94, 6, "Company's Bank Details", ln=0,border=1)
    pdf.cell(94, 6, "Declaration:", ln=1,border=1)
