...
# --- Signature Boxes (Side by Side) ---
    ...
    left_signature_box_height = 30  # <-- Change this number for left box height only
    right_signature_box_height = 31  # Keep this as is for right box
    ...
    if buyer_logo_file:
        try:
            ...
            logo_y = pdf.get_y()   # Small margin from top
    ...
    pdf.set_y(max(y_after_left_signature, y_signature_start + 5 + right_signature_box_height))
