...
def create_invoice_pdf(invoice_data, logo_file="logo_final.jpg", stamp_file="stamp.jpg"):
    ...
    pdf.set_font("Helvetica", "", 8)
    pdf.cell(47, 6, invoice_data['invoice_details']['buyers_order_no'], border="R", ln=0, align="C")
    pdf.cell(47, 6, invoice_data['invoice_details']['buyers_order_date'], border="R", ln=1, align="C")
