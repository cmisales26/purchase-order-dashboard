...
def create_invoice_pdf(invoice_data, logo_file="logo_final.jpg", stamp_file="stamp.jpg"):
    ...
    pdf.set_x(110)
    pdf.set_font("Helvetica", "B", 8)
    pdf.cell(47, 12, "Other's Reference:", border="LRT", ln=0)
    pdf.set_font("Helvetica", "", 8)
    other_ref_value = invoice_data['invoice_details'].get('other_reference', '')
    pdf.cell(47, 6, other_ref_value, border="LRT", ln=1)
    ...
    pdf.set_font("Helvetica", "", 8)
    pdf.cell(47, 4, invoice_data['invoice_details']['buyers_order_no'], border="R", ln=0, align="C")
    pdf.cell(47, 4, invoice_data['invoice_details']['buyers_order_date'], border="R", ln=1, align="C")
