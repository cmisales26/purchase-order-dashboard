...
PRODUCT_CATALOG = {
    "Software Product A": {"basic": 50000.0, "gst_percent": 18.0},
    "Software Product B": {"basic": 75000.0, "gst_percent": 18.0},
    "Software Product C": {"basic": 100000.0, "gst_percent": 18.0},
    "Service Package X": {"basic": 25000.0, "gst_percent": 18.0},
    "Service Package Y": {"basic": 45000.0, "gst_percent": 18.0},
    "Annual License": {"basic": 30000.0, "gst_percent": 18.0},
    "Premium Support": {"basic": 15000.0, "gst_percent": 18.0},
    "Training Package": {"basic": 20000.0, "gst_percent": 18.0},
    "Custom Development": {"basic": 80000.0, "gst_percent": 18.0},
    "Consulting Services": {"basic": 35000.0, "gst_percent": 18.0},
}

# Sales Person Mapping - Generic examples
SALES_PERSON_MAPPING = {
    "SP1": {"name": "Sales Person One", "email": "sales1@example.com", "mobile": "+91 98765 43210"},
    "SP2": {"name": "Sales Person Two", "email": "sales2@example.com", "mobile": "+91 98765 43211"},
    "SP3": {"name": "Sales Person Three", "email": "sales3@example.com", "mobile": "+91 98765 43212"},
    "SP4": {"name": "Sales Person Four", "email": "sales4@example.com", "mobile": "+91 98765 43213"}
}
...
class QUOTATION_PDF(FPDF):
    ...
    def footer(self):
        ...
        self.cell(0, 4, "[Your Company Address Line 1], [Your Company Address Line 2], [City] - [PIN]", ln=True, align="C")
        
        # Footer contact information
        self.set_text_color(0, 0, 255)
        
        email_text = " info@yourcompany.com"
        ...
        self.cell(0, 4, "www.yourcompany.com", ln=True, align="C", link="https://www.yourcompany.com/")
...
def add_page_one_intro(pdf, data):
    ...
    pdf.write(5, "contact@yourcompany.com", link="mailto:contact@yourcompany.com")
    ...
    pdf.set_text_color(0, 0, 255)
    pdf.set_font("Helvetica", "U", 10)
    pdf.write(5, "+91 98765 43210 ", link="tel:+919876543210")
    ...
    pdf.set_text_color(0, 0, 255)
    pdf.set_font("Helvetica", "U", 10)
    pdf.write(5, "+91 98765 43211", link="tel:+919876543211")
    ...
    # Clickable website and social media
    pdf.set_font("Helvetica", "U", 10)
    pdf.set_text_color(0, 0, 255)
    pdf.cell(0, 4, "https://www.yourcompany.com/", ln=True, link="https://www.yourcompany.com/")
    pdf.cell(0, 4, "https://www.linkedin.com/company/yourcompany", ln=True, link="https://www.linkedin.com/company/yourcompany")
    pdf.cell(0, 4, "https://wa.me/919876543210", ln=True, link="https://wa.me/919876543210")
    pdf.cell(0, 4, "https://www.facebook.com/yourcompany", ln=True, link="https://www.facebook.com/yourcompany")
    pdf.cell(0, 4, "https://www.instagram.com/yourcompany", ln=True, link="https://www.instagram.com/yourcompany")
    pdf.set_text_color(0, 0, 0)
...
def add_page_two_commercials(pdf, data):
    ...
    quotation_title = data.get('quotation_title', 'Quotation for Software Products')
    ...
    terms = [
        ...
        "TDS should not be deducted at the time of payment as per applicable government regulations.",
        "All licenses are digital and will be delivered electronically.",
        "An Internet connection is required to access cloud services.",
        "Training will be charged at extra cost depending on number of participants.",
        ...
        'Cheque to be issued on name of: "[Your Company Name]"',
        "Order to be placed on: [Your Company Name] \n[Your Company Address Line 1],\n[Your Company Address Line 2],\n[City] - [PIN Code]"
    ]
...
def create_invoice_pdf(invoice_data,logo_file=None,stamp_file=None):
    ...
    pdf.cell(95, 5, "[Your Company Name]", ln=False)
    pdf.set_xy(110, 35)
    pdf.cell(95, 5, "Buyer", ln=True)

    pdf.set_font("Helvetica", "", 8)
    pdf.set_xy(15, 40)
    pdf.multi_cell(95, 4, "[Your Company Address]")
    ...
    pdf.multi_cell(95, 4,
        f"GST No.: [Your GST Number]\n"
        f"MSME Registration No.: [Your MSME Number]"
    )
    ...
    pdf.multi_cell(0, 4,
        ...
        f"Account No.: [Your Account Number]\n"
        f"IFS Code: [Your IFSC Code]"
    )
    ...
    pdf.ln(5)
    pdf.set_font("Helvetica", "B", 8)
    pdf.cell(0, 5, "For [Your Company Name].", ln=True, align="R")
    ...
    # Company address
    pdf.cell(0, 4, "[Your Company Address Line 1], [Your Company Address Line 2], [City] - [PIN]", ln=True, align="C")
    ...
    pdf.cell(0, 4, "www.yourcompany.com", ln=True, align="C", link="https://www.yourcompany.com/")
...
class PO_PDF(FPDF):
    ...
    def footer(self):
        ...
        self.multi_cell(0, 4, "[Your Company Address Line 1], [Your Company Address Line 2], [City] - [PIN]\n", align="C")
        self.set_text_color(0, 0, 255)
        email1 = "info@yourcompany.com"
        phone_number ="+91 98765 43210"
...
def main():
    ...
    with tab1:
        ...
        with col1:
            ...
            invoice_no = st.text_input("Invoice No", "INV/25-26/Q1/001")
            invoice_date = st.text_input("Invoice Date", datetime.date.today().strftime("%d %B %Y"))
            buyers_order_no = st.text_input("Buyer's Order No.", "PO-001")
            buyers_order_date = st.text_input("Buyer's Order Date", datetime.date.today().strftime("%d %B %Y"))
            dispatched_through = st.text_input("Dispatched Through", "Email/Courier")
            terms_of_delivery = st.text_input("Terms of delivery", "Within 7 Days")
            destination = st.text_input("Destination", "Mumbai")
            
            st.subheader("Seller Details")
            vendor_name = st.text_input("Seller Name", "[Your Company Name]")
            vendor_address = st.text_area("Seller Address", "[Your Company Address Line 1]\n[Your Company Address Line 2]\n[City] - [PIN Code]")
            vendor_gst = st.text_input("Seller GST No.", "[Your GST Number]")
            vendor_msme = st.text_input("Seller MSME Registration No.", "[Your MSME Number]")

            st.subheader("Buyer Details")
            buyer_name = st.text_input(
                "Buyer Name",
                value = st.session_state.get("po_end_company","Customer Company Pvt Ltd.")
            )
            buyer_address = st.text_area(
                "Buyer Address",
                value=st.session_state.get("po_end_address","Customer Address Line 1\nCustomer Address Line 2\nCity - PIN Code")
            )
            buyer_gst = st.text_input(
                "Buyer GST No.",
                value=st.session_state.get("po_end_gst_no","[Customer GST Number]")
            )
            ...
            for i in range(num_items):
                with st.expander(f"Product {i+1}"):
                    desc = st.text_area(f"Description {i+1}", "Software Product License\nAnnual Subscription\nSerial #XXXXXXX\nContract #XXXXXXX")
                    hsn = st.text_input(f"HSN/SAC {i+1}", "998332")
                    qty = st.number_input(f"Quantity {i+1}", 1.00, 100.00, 1.00)
                    rate = st.number_input(f"Unit Rate {i+1}", 0.00, 100000.00, 25000.00)
                    items.append({"description": desc, "hsn": hsn, "quantity": qty, "unit_rate":rate})

            st.subheader("Bank Details")
            bank_name = st.text_input("Bank Name", "[Your Bank Name]")
            bank_branch = st.text_input("Branch", "[Your Branch Name]")
            account_no = st.text_input("Account No.", "[Your Account Number]")
            ifsc = st.text_input("IFS Code", "[Your IFSC Code]")

            st.subheader("Declaration")
            declaration = st.text_area("Declaration", "This is a computer generated invoice and does not require a physical signature.")
        ...
        with tab_vendor:
            ...
            with col1:
                vendor_name = st.text_input(
                    "Vendor Name",
                    value=safe_str_state("po_vendor_name", "Supplier Company Pvt Ltd."),
                    key="po_vendor_name_input"
                )
                vendor_address = st.text_area(
                    "Vendor Address",
                    value=safe_str_state("po_vendor_address", "Supplier Address Line 1\nSupplier Address Line 2\nCity - PIN Code"),
                    key="po_vendor_address_input"
                )
                vendor_contact = st.text_input(
                    "Contact Person",
                    value=safe_str_state("po_vendor_contact", "Mr. Supplier Contact"),
                    key="po_vendor_contact_input"
                )
                vendor_mobile = st.text_input(
                    "Mobile",
                    value=safe_str_state("po_vendor_mobile", "+91 98765 43210"),
                    key="po_vendor_mobile_input"
                )
                end_company = st.text_input(
                    "End User Company",
                    value=safe_str_state("po_end_company", "End User Company Pvt Ltd."),
                    key="po_end_company_input"
                )
                end_address = st.text_area(
                    "End User Address",
                    value=safe_str_state("po_end_address", "End User Address Line 1\nEnd User Address Line 2\nCity - PIN Code"),
                    key="po_end_address_input"
                )
                end_person = st.text_input(
                    "End User Contact",
                    value=safe_str_state("po_end_person", "Mr. End User"),
                    key="po_end_person_input"
                )
                end_contact = st.text_input(
                    "End User Phone",
                    value=safe_str_state("po_end_contact", "+91 98765 43211"),
                    key="po_end_contact_input"
                )
                end_email = st.text_input(
                    "End User Email",
                    value=safe_str_state("po_end_email", "enduser@example.com"),
            ...
            with col2:
                ...
                bill_to_address = st.text_area(
                    "Bill To Address",
                    value=safe_str_state("po_bill_to_address", "[Your Company Address Line 1]\n[Your Company Address Line 2]\n[City] - [PIN Code]"),
                ...
                ship_to_address = st.text_area(
                    "Ship To Address",
                    value=safe_str_state("po_ship_to_address", "[Your Company Address Line 1]\n[Your Company Address Line 2]\n[City] - [PIN Code]"),
                    key="po_ship_to_address_input"
                )
                gst_no = st.text_input(
                    "GST No",
                    value=safe_str_state("po_gst_no", "[Your GST Number]"),
                    key="po_gst_no_input"
                )
                pan_no = st.text_input(
                    "PAN No",
                    value=safe_str_state("po_pan_no", "[Your PAN Number]"),
                    key="po_pan_no_input"
                )
                msme_no = st.text_input(
                    "MSME No",
                    value=safe_str_state("po_msme_no", "[Your MSME Number]"),
    ...
    with tab3:
        ...
        with col1:
            ...
            vendor_name = st.text_input("Company Name", "Customer Company Pvt Ltd.", key="quote_vendor_name")
            vendor_address = st.text_area("Company Address", "Customer Address Line 1\nCustomer Address Line 2\nCity - PIN Code", key="quote_vendor_address")
            vendor_email = st.text_input("Email", "customer@example.com", key="quote_vendor_email")
            vendor_contact = st.text_input("Contact Person (Kind Attention)", "Mr. Customer Contact", key="quote_vendor_contact")
            vendor_mobile = st.text_input("Mobile", "+91 98765 43210", key="quote_vendor_mobile")

            st.header("Quotation Details")
            price_validity = st.text_input("Price Validity", "30 Days", key="quote_price_validity")
            subject_line = st.text_input("Subject", "Proposal for Software Products and Services", key="quote_subject")
            intro_paragraphs = st.text_area("Introduction Paragraphs",
            """This is with reference to your requirement for our software products and services. We are pleased to submit our quotation for your consideration.

Our company specializes in providing innovative software solutions that help businesses streamline their operations and achieve their goals. With years of experience in the industry, we have built a reputation for delivering high-quality products and exceptional customer service.

We are confident that our proposed solution will meet your requirements and provide excellent value for your investment. Our team is committed to ensuring your success and will provide comprehensive support throughout the implementation process.

Thank you for considering our proposal. We look forward to the opportunity to work with you and contribute to your organization's growth and success.""",
            key="quote_intro"
            )
        ...
        with col2:
            ...
            with col_title:
                quotation_title = st.text_input(
                    "Quotation Title", 
                    "Quotation for Software Products", 
        ...
        # Show the current quotation number
    ...
    for path in ["temp_logo.jpg", "temp_stamp.jpg", "temp_logo_quote.jpg", "temp_stamp_quote.jpg", "temp_logo_po.jpg"]:
